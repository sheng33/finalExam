...
<div class="container">
    <div class="row row-centered" style="position: relative">
        ...
        <div class="col-md-6 col-centered no-gutters">
            <form style="text-align: center; height: 400px" method="get" action="/Search/searchCarId">
                ...
                <ul  style="list-style: none; width: 500px">
                    <li class="input-group input-group-lg col-12 col-sm-6 col-md-8" >
                        ...
                        <input type="text" id="searchCarId" name="searchCarId"
...
<script>
    $("#searchCarId").typeahead({
        source: function (query, process) {
            return $.ajax({
                url: '/Search/searchCar',
                type: 'get',
                data: {carId: query},
                success: function (result) {
                    var resultList = result.map(function (item) {
                        var aItem = {id: item.carId};
